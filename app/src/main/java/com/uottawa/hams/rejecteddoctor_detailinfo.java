...
public class rejecteddoctor_detailinfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rejecteddoctor_detailinfo);
        ...
        if (intent != null) {
            ...
            if (doctorId != -1) {
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    passwordTextView.setText("Account Password: " + cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.D_PWD)));
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (doctorId != -1) {
                    DatabaseManager dbManager = new DatabaseManager(rejecteddoctor_detailinfo.this);
                    try {
                        dbManager.open();
                    } catch (SQLDataException e) {
                        throw new RuntimeException(e);
